...
<body scroll="no">
		...
		<div id="header">
			<div class="headerNav">
				...
				<ul class="nav">
					...
					<li><a href="../user/goPwd" target="dialog" mask=true minable=false ref="dlg_user_edit" title="修改" width="550" height="200">修改密码</a></li>
	...
	<div id="footer">Copyright &copy; <%=basePath %></div>
